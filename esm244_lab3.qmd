...
The data exist in `data/red_sesbania`, and the shapefile is stored as `ds80_for_lab.gpkg`. Let's read in the data: 
...
Let's say we want to find the count of red sesbania observed locations in this dataset *by county*.  Write pseudocode to accomplish this.
